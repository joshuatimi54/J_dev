        ...
        <main>
            ...
            <div className="site text-center">
                <ul>
                    ...
                    <li>
                        <a href="https://github.com/joshuatimi54" target="_blank" rel="noopener noreferrer">
                            <i class="fa fa-github" aria-hidden="true"></i>
                        </a>
                    </li>
                    <li>
                        <a href="http://www.linkedin.com/in/joshua-adesoba-9144bb232" target="_blank" rel="noopener noreferrer">
                            <i class="fa fa-linkedin-square" aria-hidden="true"></i>
                        </a>
                    </li>
                    <li>
                        <a href="https://wa.me/message/TBTYBWC3YLNUK1" target="_blank" rel="noopener noreferrer">
